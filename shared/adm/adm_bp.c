...
//	adm_add_datadef("BP_NODE_ALL",                 mid_str, 0,  bp_print_node_all,       bp_size_node_all);
	...
	adm_add_datadef("BP NODE ID",                  mid_str, 0,  adm_string_to_queue, adm_size_string/*bp_size_node_id*/);

	adm_build_mid_str(0, BP_ADM_DATA_NN, BP_ADM_DATA_NN_LEN, 2, mid_str);
	adm_add_datadef("BP_NODE_VER",                 mid_str, 0,  adm_string_to_queue, adm_size_string/*bp_size_node_version*/);
...
//	adm_build_mid_str(0x0, BP_ADM_DATA_END_NN, BP_ADM_DATA_END_NN_LEN, 43, mid_str);
//	adm_add_datadef("BP_CONTACT_LIST", mid_str, 0, bp_print_contact_list, bp_size_contact_list);

	/* Plan specific Information */
//	adm_build_mid_str(0x0, BP_ADM_DATA_END_NN, BP_ADM_DATA_END_NN_LEN, 44, mid_str);
//	adm_add_datadef("BP_CONTACT_LIST", mid_str, 0, bp_print_plan_list, bp_size_plan_list);
...
//	adm_add_datadef("BP_ENDPT_ALL",                  mid_str, 1, bp_print_endpoint_all,   bp_size_endpoint_all);
	...
	adm_add_datadef("BP_ENDPT_NAME",                 mid_str, 1, adm_string_to_queue,        bp_size_endpoint_name);
