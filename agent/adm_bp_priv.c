...
/*
	adm_build_mid_str(0x41, BP_ADM_DATA_CTRL_NN, BP_ADM_DATA_CTRL_NN_LEN, 1, mid_str);
	adm_add_ctrl_run(mid_str,  ion_ctrl_outduct_add);

	adm_build_mid_str(0x41, BP_ADM_DATA_CTRL_NN, BP_ADM_DATA_CTRL_NN_LEN, 2, mid_str);
	adm_add_ctrl_run(mid_str,  ion_ctrl_outduct_remove);

	adm_build_mid_str(0x41, BP_ADM_DATA_CTRL_NN, BP_ADM_DATA_CTRL_NN_LEN, 3, mid_str);
	adm_add_ctrl_run(mid_str,  ion_ctrl_contact_add);

	adm_build_mid_str(0x41, BP_ADM_DATA_CTRL_NN, BP_ADM_DATA_CTRL_NN_LEN, 4, mid_str);
	adm_add_ctrl_run(mid_str,  ion_ctrl_contact_remove);

	adm_build_mid_str(0x41, BP_ADM_DATA_CTRL_NN, BP_ADM_DATA_CTRL_NN_LEN, 5, mid_str);
	adm_add_ctrl_run(mid_str,ion_ctrl_group_add);

	adm_build_mid_str(0x41, BP_ADM_DATA_CTRL_NN, BP_ADM_DATA_CTRL_NN_LEN, 6, mid_str);
...
expr_result_t bp_node_get_all(Lyst params)
{
	...
	result.value = (uint8_t*) STAKE(sizeof(node_state) + sizeof(state));
...
expr_result_t bp_endpoint_get_all(Lyst params)
{
	...
	if(success != 0)
	{
		result.value = (uint8_t*) STAKE(sizeof(endpoint));
...
{
	DTNMP_DEBUG_INFO("bp_reset","()",NULL);
